 ...
 * @author 1572
 */
public class form_uang_masuk extends javax.swing.JFrame {

    /**
     * Creates new form form_menu_utama
     */
    public form_uang_masuk() {
        initComponents();
        Tampil_pemasukan();
        //init();
    ...
    public void pencarian_uang_masuk(){
        ...
        tbl_uang_masuk.setModel(tabmode);
            ...
            try {
                String sql = "select * from tb_transaksi where tanggal like '%"+cari+"%' && jenis_transaksi = 'masuk'";
                java.sql.Statement stat = conn.createStatement();
                java.sql.ResultSet hasil = stat.executeQuery(sql);
                while (hasil.next()){
                    String tanggal = hasil.getString("tanggal");
                    String keterangan = hasil.getString("keterangan");
                    String jumlah = hasil.getString("jumlah_pemasukan");
    ...
    public void Tampil_pemasukan()
    {
        ...
        tbl_uang_masuk.setModel(tabmode);
            ...
            try {
                String sql = "select * from tb_transaksi where jenis_transaksi like 'masuk'";
                java.sql.Statement stat = conn.createStatement();
                java.sql.ResultSet hasil = stat.executeQuery(sql);
                while (hasil.next()){
    ...
    private void kliktable() throws ParseException{
        int baris = tbl_uang_masuk.getSelectedRow();
        
        form_entry_update_masuk mn = new form_entry_update_masuk();
        mn.txt_no_kwitansi.setText((String)tbl_uang_masuk.getValueAt(baris, 0));
        ...
        mn.setVisible(true);
         ...
         try{
               ...
               if (hasil.next()) {
                   form_entry_update_masuk.txt_tanggal.setDate(hasil.getDate("tanggal"));
                   form_entry_update_masuk.txt_ket.setText(hasil.getString("keterangan"));
                   form_entry_update_masuk.txt_jumlah.setText(hasil.getString("jumlah_pemasukan")); 
               }
         }catch(Exception E)
         {}
...
//        card3.setData(new ModelCard(null, null, null, "$ 300.00", "Report Profit Monthly"));
    ...
    private void initComponents() {
        ...
        tbl_uang_masuk = new javaswingdev.swing.table.Table();
        ...
        tbl_uang_masuk.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbl_uang_masuk.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbl_uang_masukMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbl_uang_masuk);
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        // TODO add your handling code here:
   form_entry_uang_masuk mn = new form_entry_uang_masuk();;
        mn.setVisible(true);
    ...
    private void tbl_uang_masukMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_uang_masukMouseClicked
        try {
            // TODO add your handling code here:
            kliktable();
        } catch (ParseException ex) {
            Logger.getLogger(form_uang_masuk.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_tbl_uang_masukMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_uang_masuk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_uang_masuk().setVisible(true);
            }
        });
    }
    ...
    private javaswingdev.swing.table.Table tbl_uang_masuk;
