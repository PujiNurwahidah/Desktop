 ...
 * @author 1572
 */
public class form_kategori_pengeluaran extends javax.swing.JFrame {

    /**
     * Creates new form form_menu_utama
     */
    public form_kategori_pengeluaran() {
        initComponents();
        Tampil_pemasukan();
        //init();
    ...
    public void pencarian_pemasukan(){
        ...
        table_pengeluaran.setModel(tabmode);
            ...
            try {
                String sql = "select * from tb_pengeluaran where nama_pembayar like '%"+cari+"%' || no_kwitansi like '%"+cari+"%'";
    ...
    public void Tampil_pemasukan()
    {
       table_pengeluaran.fixTable(jScrollPane1);
        ...
        table_pengeluaran.setModel(tabmode);
            ...
            try {
                String sql = "select * from tb_pengeluaran order by id asc";
                java.sql.Statement stat = conn.createStatement();
                java.sql.ResultSet hasil = stat.executeQuery(sql);
                while (hasil.next()){
                    String no_kwitansi = hasil.getString("no_kwitansi");
...
//        card3.setData(new ModelCard(null, null, null, "$ 300.00", "Report Profit Monthly"));
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Kategori Pengeluaran");
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        // TODO add your handling code here:
        form_entry_pengeluaran mn = new form_entry_pengeluaran();;
        mn.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_kategori_pengeluaran.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_kategori_pengeluaran().setVisible(true);
            }
        });
    }
