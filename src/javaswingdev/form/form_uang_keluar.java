 ...
 * @author 1572
 */
public class form_uang_keluar extends javax.swing.JFrame {

    /**
     * Creates new form form_menu_utama
     */
    public form_uang_keluar() {
        initComponents();
        Tampil_uang_keluar();
        //init();
    ...
    private void kliktable() throws ParseException{
        int baris = tbl_uang_keluar.getSelectedRow();
        
        form_entry_update_keluar mn = new form_entry_update_keluar();
        mn.txt_no_kwitansi.setText((String)tbl_uang_keluar.getValueAt(baris, 0));
        String kode = mn.txt_no_kwitansi.getText();
        mn.setVisible(true);
       
         try{

               String sql1 = "SELECT * FROM tb_transaksi WHERE kode_transaksi = '"+kode+"'";
               java.sql.Statement st = conn.createStatement();
               java.sql.ResultSet hasil = st.executeQuery(sql1);
               if (hasil.next()) {
                   form_entry_update_keluar.txt_tanggal.setDate(hasil.getDate("tanggal"));
                   form_entry_update_keluar.txt_ket.setText(hasil.getString("keterangan"));
                   form_entry_update_keluar.txt_jumlah.setText(hasil.getString("jumlah_pengeluaran")); 
               }
         }catch(Exception E)
         {}
    ...
    public void pencarian_uang_keluar(){
        String cari = txt_cari.getText();
        
        tbl_uang_keluar.fixTable(jScrollPane1);
        Object []baris = {"Tanggal", "Keterangan", "Jumlah"};
        tabmode = new DefaultTableModel(null, baris);
        tbl_uang_keluar.setModel(tabmode);
        
            try {
                String sql = "select * from tb_transaksi where tanggal like '%"+cari+"%' && jenis_transaksi = 'keluar'";
                java.sql.Statement stat = conn.createStatement();
                java.sql.ResultSet hasil = stat.executeQuery(sql);
                while (hasil.next()){
                    String tanggal = hasil.getString("tanggal");
                    String keterangan = hasil.getString("keterangan");
                    String jumlah = hasil.getString("jumlah_pengeluaran");
    ...
    public void Tampil_uang_keluar()
    {
        tbl_uang_keluar.fixTable(jScrollPane1);
        Object []baris = {"Kode Transaksi","Tanggal", "Keterangan", "Jumlah"};
        tabmode = new DefaultTableModel(null, baris);
        tbl_uang_keluar.setModel(tabmode);
        
            try {
                String sql = "select * from tb_transaksi where jenis_transaksi like 'keluar'";
                java.sql.Statement stat = conn.createStatement();
                java.sql.ResultSet hasil = stat.executeQuery(sql);
                while (hasil.next()){
                    String kode = hasil.getString("kode_transaksi");
                    String tanggal = hasil.getString("tanggal");
                    String keterangan = hasil.getString("keterangan");
                    String jumlah = hasil.getString("jumlah_pengeluaran");
    ...
    private void init() {
        tbl_uang_keluar.fixTable(jScrollPane1);
        tbl_uang_keluar.addRow(new Object[]{"1", "Mike Bhand", "mikebhand@gmail.com", "Admin", "25 Apr,2018"});
        tbl_uang_keluar.addRow(new Object[]{"2", "Andrew Strauss", "andrewstrauss@gmail.com", "Editor", "25 Apr,2018"});
       tbl_uang_keluar.addRow(new Object[]{"3", "Ross Kopelman", "rosskopelman@gmail.com", "Subscriber", "25 Apr,2018"});
        tbl_uang_keluar.addRow(new Object[]{"4", "Mike Hussy", "mikehussy@gmail.com", "Admin", "25 Apr,2018"});
       tbl_uang_keluar.addRow(new Object[]{"5", "Kevin Pietersen", "kevinpietersen@gmail.com", "Admin", "25 Apr,2018"});
        tbl_uang_keluar.addRow(new Object[]{"6", "Andrew Strauss", "andrewstrauss@gmail.com", "Editor", "25 Apr,2018"});
        tbl_uang_keluar.addRow(new Object[]{"7", "Ross Kopelman", "rosskopelman@gmail.com", "Subscriber", "25 Apr,2018"});
        tbl_uang_keluar.addRow(new Object[]{"8", "Mike Hussy", "mikehussy@gmail.com", "Admin", "25 Apr,2018"});
        tbl_uang_keluar.addRow(new Object[]{"9", "Kevin Pietersen", "kevinpietersen@gmail.com", "Admin", "25 Apr,2018"});
        tbl_uang_keluar.addRow(new Object[]{"10", "Kevin Pietersen", "kevinpietersen@gmail.com", "Admin", "25 Apr,2018"});
        tbl_uang_keluar.addRow(new Object[]{"11", "Andrew Strauss", "andrewstrauss@gmail.com", "Editor", "25 Apr,2018"});
        tbl_uang_keluar.addRow(new Object[]{"12", "Ross Kopelman", "rosskopelman@gmail.com", "Subscriber", "25 Apr,2018"});
        tbl_uang_keluar.addRow(new Object[]{"13", "Mike Hussy", "mikehussy@gmail.com", "Admin", "25 Apr,2018"});
        tbl_uang_keluar.addRow(new Object[]{"14", "Kevin Pietersen", "kevinpietersen@gmail.com", "Admin", "25 Apr,2018"});
...
//        card3.setData(new ModelCard(null, null, null, "$ 300.00", "Report Profit Monthly"));
    ...
    private void initComponents() {
        ...
        tbl_uang_keluar = new javaswingdev.swing.table.Table();
        ...
        panelTransaksiLayout.setVerticalGroup(
            ...
            .addGroup(panelTransaksiLayout.createSequentialGroup()
                .addComponent(btnBarangMasuk, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tbl_uang_keluar.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbl_uang_keluar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbl_uang_keluarMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbl_uang_keluar);
 ...
 this.dispose();
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        form_entry_uang_keluar mn = new form_entry_uang_keluar();;
        mn.setVisible(true);
    ...
    private void tbl_uang_keluarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_uang_keluarMouseClicked
        try {
            // TODO add your handling code here:
            kliktable();
        } catch (ParseException ex) {
            Logger.getLogger(form_uang_keluar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_tbl_uang_keluarMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_uang_keluar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_uang_keluar().setVisible(true);
            }
        });
    }
    ...
    private javaswingdev.swing.table.Table tbl_uang_keluar;
